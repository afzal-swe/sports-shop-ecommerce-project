				...
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div>
                                <x-text-input type="email" name="email" value="{{old('email')}}" placeholder="example@gmail.com" required autofocus autocomplete="username" />
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<form method="POST" action="{{ route('register') }}">
                            ...
                            <div>
                                <input id="email" type="text" name="email" value="{{old('email')}}" placeholder="example@gmail.com" required autofocus>
                            </div>
